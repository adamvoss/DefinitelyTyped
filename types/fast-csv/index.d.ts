...
declare namespace fast_csv {
    ...
    function writeToBuffer(arr: Buffer, options: FormattingOptions | undefined, cb: ((error: (err: any) => void, result?: (data: string) => void) => void)): void;
    ...
    function writeToString(arr: any[], options: FormattingOptions | undefined, cb: ((error: (err: any) => void, result?: (data: string) => void) => void)): void;
}
